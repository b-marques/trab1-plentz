...
public class JanelaSocio extends JFrame implements ActionListener {
	...
	public JanelaSocio(Pessoa[][] array){
		
		super("Escolha um dos assentos disponiveis para Socio");
		...
		for (int linha=0; linha<10;linha++){
			for (int coluna=0; coluna<14; coluna++ ){
				if(estadio.arrayDoEstadio[linha][coluna].getNome().equals("Socio")){
					if(coluna <10){
